...
export function Navbar() {
  ...
  useEffect(() => {
    ...
    const updateNavbar = () => {
      ...
      const shouldShow = currentScrollY <= 8 || delta < 0;
      const shouldHide = delta > 4 && currentScrollY > 96;
  ...
  return (
    <>
      <header
        ...
        data-visible="true"
        data-scrolled="false"
        className="fixed inset-x-0 top-0 z-50 border-b border-olive/10 bg-cream/94 shadow-none backdrop-blur-xl will-change-transform transition-[transform,box-shadow] duration-300 ease-out data-[scrolled=true]:shadow-[0_18px_55px_rgba(26,35,27,0.12)] data-[visible=false]:-translate-y-full data-[visible=true]:translate-y-0"
      >
